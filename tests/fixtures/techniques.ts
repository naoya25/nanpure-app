...
export const TECHNIQUE_CASES: TechniqueCaseBase[] = [
...

  {
    ...
    expected: {
      ...
      candidateMasks81: [
        0, 88, 64, 0, 316, 28, 310, 358, 94, 0, 88, 0, 400, 0, 152, 400, 449, 217,
        2, 0, 1, 0, 60, 156, 182, 167, 159, 340, 0, 384, 20, 9, 9, 148, 196, 0, 84,
        240, 0, 34, 116, 0, 0, 198, 214, 84, 0, 96, 34, 0, 84, 0, 70, 0, 321, 0, 0,
        400, 337, 0, 384, 0, 129, 8, 232, 0, 388, 325, 197, 422, 423, 135, 257, 160,
        384, 0, 261, 0, 0, 0, 133,
      ],
    },
  },
